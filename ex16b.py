...
target.truncate() #runs operation truncate on the file (truncates to zero in this case?) but as we have opened in w mode is uneccessary as that opens and truncates automatically
